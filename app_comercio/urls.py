...
from .views import AboutPageView, ClientePageView, HomePageView, AddClientePageView, MonitorPageView, \
    AddComputadorPageView, MousePageView, ComputadorPageView, AddMonitorPageView, AddMousePageView, DeleteClientView, DeleteMouseView, DeleteMonitorView, DeleteComputadorView
...
urlpatterns = [
    ...
    path('/monitor', DeleteMonitorView.as_view(), name='delete_monitor'),
    path('/mouse', DeleteMouseView.as_view(), name='delete_mouse'),
    path('/computador', DeleteComputadorView.as_view(), name='delete_computador'),
